...
router.post("/", multer_1.default.single("image"), function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, title, description, imagePath, newScetion, error_1;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _c.sent();
                return [2 /*return*/, res.status(201).send({ message: "تم انشاء قسم جديد بنجاح" })];
            case 2:
                error_1 = _c.sent();
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = req.body, title = _a.title, description = _a.description;
                id = req.params.id;
                return [4 /*yield*/, section_model_1.default.find({ _id: id })];
            case 1:
                section = _c.sent();
            ...
            case 2:
                updateSection = _c.sent();
                if (!updateSection) {
                    return [2 /*return*/, res.status(404).send({ message: "section not found" })];
                }
