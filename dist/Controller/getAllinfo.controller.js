...
router.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, team, sections, projects, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Promise.all([
                        team_model_1.default.find({}, { _id: 0, __v: 0 }),
                        section_model_1.default.find({}, { _id: 0, __v: 0 }),
                        project_model_1.default.find({}, { _id: 0, __v: 0 }),
                    ])];
            case 1:
                _a = _b.sent(), team = _a[0], sections = _a[1], projects = _a[2];
                return [2 /*return*/, res.status(200).send({ team: team, sections: sections, projects: projects })];
            case 2:
                err_1 = _b.sent();
