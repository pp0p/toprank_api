...
router.post("/", rateLimiter_1.rateLimiterMiddleware, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, title, name, message, Message, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, title = _a.title, name = _a.name, message = _a.message;
                if (!title || !name || !message) {
                    res.status(400).send({ message: "Please add all fields" });
                }
                Message = new message_model_1.default({ title: title, name: name, message: message });
...
router.delete("/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, message, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, message_model_1.default.findByIdAndRemove(id)];
            case 1:
                message = _a.sent();
                if (!message) {
                    console.log(message);
